//LISTAS DE CHUVA DE METEORO, UMA PARA CADA TRIMESTRE
...
// PEGANDO DATA ATUAL E MÊS
var data_atual = new Date();
var mes_atual = data_atual.getMonth();

// Utilizando a estrutura if para validar, o sistema irá imprimir apenas
// as chuvas de meteoro do trimestre atual.

if (mes_atual == 0 || mes_atual == 1 || mes_atual == 2) {
    console.log("As chuvas de meteoro do primeiro trimestre são:\n\n" + meteoros_trimestre_um);
} else if (mes_atual == 3 || mes_atual == 4 || mes_atual == 5) {
    console.log("As chuvas de meteoro do segundo trimestre são:\n\n" + meteoros_trimestre_dois);
} else if (mes_atual == 6 || mes_atual == 7 || mes_atual == 8) {
    console.log("As chuvas de meteoro do terceiro trimestre são:\n\n" + meteoros_trimestre_tres);
} else if (mes_atual == 9 || mes_atual == 10 || mes_atual == 11) {
    console.log("As chuvas de meteoro do quarto trimestre são:\n\n" + meteoros_trimestre_quatro);
} else {
