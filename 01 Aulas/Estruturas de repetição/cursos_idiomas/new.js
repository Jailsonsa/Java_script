...
for (let curso of curso_idiomas) {
    ...
    let precoDaCargaHoraria = preco_curso / carga_horaria_curso;
    ...
    if (precoDaCargaHoraria >= 15) {
        console.log(`Hora/Aula é superior ou igual a R$15,00`);
    } else {
        console.log(`Hora/Aula é inferior a R$15,00`);
    }
    console.log("\n");
}
